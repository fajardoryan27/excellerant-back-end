...
const CNCProdAssocRoles = db.CNCProdAssocRoles;
...
exports.create = (req, res) => {
    ...
    if (!req.body.program_id) {
      ...
      const cncProdAssocRoles = {
        program_id: req.body.program_id,
        role_id: req.body.role_id,
      };

    
      CNCProdAssocRoles.create(cncProdAssocRoles)
        .then(data => {
          res.send(data);
        })
        .catch(err => {
...
exports.findAll = (req, res) => {
    ...
    CNCProdAssocRoles.findAll({ where: condition })
      .then(data => {
        res.send(data);
      })
      .catch(err => {
...
exports.update = (req, res) => {
    const id = req.params.id;
    console.log(id)
    CNCProdAssocRoles.update(req.body, {
      where: { id: id }
    })
      .then(num => {
        if (num == 1) {
...
exports.findAllPublished = (req, res) => {
    CNCProdAssocRoles.findAll({ where: { published: true } })
    .then(data => {
      res.send(data);
    })
    .catch(err => {
