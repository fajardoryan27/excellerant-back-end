...
db.CNCProdAssocRoles = require("./CNCProdAssocRoles.js")(sequelize, Sequelize);
db.CNCDownloadAssocRoles = require("./CNCDownloadAssocRoles.js")(sequelize, Sequelize);
db.partsProdUserRoles = require("./PartsProdUserRoles.js")(sequelize, Sequelize);
db.machineDLStatUserRoles = require("./MachineDLStatUserRoles.js")(sequelize, Sequelize);
db.partNotes = require("./PartNotes.js")(sequelize, Sequelize);
db.operationNotes = require("./OperationsNotes.js")(sequelize, Sequelize);
db.cncProgramNotes = require("./CNCProgramNotes.js")(sequelize, Sequelize);
db.cncProgramRevision = require("./CNCRevisionListing.js")(sequelize, Sequelize);
